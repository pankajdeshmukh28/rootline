...
Everything lives under one `Tree` object (`people`, `unions`, `rootPersonId`), and multiple trees are kept side by side in `localStorage` under `kinfolk.familytree.v1`.
